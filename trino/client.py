...
class TrinoQuery(object):
    ...
    def __init__(
        ...
        self._row_mapper: Optional[RowMapperBase] = None
...
class NoOpRowMapper(RowMapperBase):
    """
...
class RowMapperFactory:
    ...
    def create(self, columns: Any, legacy_primitive_types: bool) -> Optional[RowMapperBase]:
